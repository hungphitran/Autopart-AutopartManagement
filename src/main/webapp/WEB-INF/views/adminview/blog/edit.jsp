            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form:form action="${pageContext.request.contextPath}/admin/blog/edit.htm" method="post" modelAttribute="blog">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="blogId">Mã bài viết <span class="required-text">*</span></label>
                                            <form:input type="text" class="form-control" id="blogId" name="blogId" path="blogId" readonly="true" />
                                        </div>
                                        <div class="form-group">
                                            <label for="title">Tiêu đề bài viết <span class="required-text">*</span></label>
                                            <form:input required="true" type="text" class="form-control" id="title" name="title" path="title" placeholder="Nhập tiêu đề blog" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <form:textarea required="true" class="form-control scrollable-textarea" id="description" name="description" path="description" rows="20" placeholder="Nhập nội dung bài viết" />
                                        </div>
