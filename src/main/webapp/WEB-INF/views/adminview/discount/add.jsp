                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Thêm Khuyến Mãi</h6>
                        </div>
                        <div class="card-body">
                            <form:form action="${pageContext.request.contextPath}/admin/discount/add.htm" method="post" modelAttribute="discount">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="discountId">Mã khuyến mãi <span class="required-text">*</span></label>
                                            <input required type="text" class="form-control" id="discountId" name="discountId" value="${nextDiscountId}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="discountDesc">Mô tả khuyến mãi <span class="required-text">*</span></label>
                                            <input required type="text" class="form-control" id="discountDesc" name="discountDesc" placeholder="Nhập mô tả khuyến mãi">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="number" step="0.01" class="form-control" id="minimumAmount" name="minimumAmount" placeholder="Nhập số tiền tối thiểu (VND)">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="usageLimit">Giới hạn sử dụng <span class="required-text">*</span></label>
                                            <input required type="number" class="form-control" id="usageLimit" name="usageLimit" placeholder="Nhập số lần sử dụng tối đa">
                                        </div>
                                        <div class="form-group">
                                            <label for="applyStartDate">Ngày bắt đầu <span class="required-text">*</span></label>
                                            <input required type="date" class="form-control" id="applyStartDate" name="applyStartDate">
                                        </div>
                                        <div class="form-group">
                                            <label for="applyEndDate">Ngày kết thúc <span class="required-text">*</span></label>
                                            <input required type="date" class="form-control" id="applyEndDate" name="applyEndDate">
                                        </div>
