...
<link href="<c:url value='/resources/css/filterproduct.css' />"
	rel="stylesheet">
<style>
body {
				...
				<div class="form-group">
					...
					<select id="brand-filter" name="brand" class="form-control">
						...
						<c:forEach var="b" items="${brands}">
								<c:choose>
									<c:when test="${brand!=null && b.brandName.equals(brand)}">
				...
				<div class="form-group">
					...
					<select id="category-filter" name="category" class="form-control">
						...
						<c:forEach var="g" items="${categories}">
							<c:choose>
								<c:when
									test="${group != null && g.groupName.equals(group)}">
									<option value="${g.productGroupId}" selected>${g.groupName}</option>
								</c:when>
								<c:otherwise>
			...
			<div class="list-card">
				<c:forEach items="${products}" var="product">
					<div class="card" style="width: 18rem;"
						...
						<a
							href="/autopart/product/detailproduct.htm?productId=${product.productId}">
