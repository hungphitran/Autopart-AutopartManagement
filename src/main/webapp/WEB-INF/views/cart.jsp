        ...
        <div class="row">
                ...
                <div class="title">
                    <div class="row">
                        <img
                            ...
                            class="cart_logo-img"
                        >	
                        <div class="col cart_title"><h4><b>Giỏ hàng</b></h4></div>
                        <div class="col align-self-center text-right text-muted">3 món</div>
                    </div>
                </div>    
                <div class="cart-list">
                    <div class="row border-bottom">
                        <div class="row main align-items-center">
                            <div class="col-2"><img class="img-fluid" src="https://html.themability.com/autoelite/assets/images/categories/1.png"></div>
                            <div class="col">
                                <div class="row text-muted">Động cơ</div>
                                <div class="row">Động cơ siu VIP</div>
                            </div>
                            <div class="col updateQTY">
                                <button class="btn-updateQTY" onclick="updateQuantity(this.nextElementSibling, -1)">-</button>
                                <input class="input-updateQTY" type="number" value="1" min="1" readonly>
                                <button class="btn-updateQTY" onclick="updateQuantity(this.previousElementSibling, 1)">+</button>
                            </div>
                            <div class="col">1.000.000 &#8363;<span class="close">&#10005;</span></div>
                        </div>
                    </div>
                    <div class="row border-bottom">
                        <div class="row main align-items-center">
            ...
            <div class="col-md-4 summary">
                ...
                <form>
                    <p>Loại vận chuyển</p>
                    <select>
                        <option class="text-muted">Vận chuyển thường- 20.000 &#8363;</option>
                        <option class="text-muted">Vận chuyển nhanh- 50.000 &#8363;</option>
                        <option class="text-muted">Vận chuyển tiết kiệm- 15.000 &#8363;</option>
                    </select>
                    <p>Mã khuyến mãi</p>
